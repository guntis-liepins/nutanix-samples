...
def main():
   ...
   vm_name="nutanixapitest-vm-name"    #Name of VM
   vm_ip=None      #VM IP , optional if DHCP set network_cfg to none
   vm_description="Nutanix API VM test" #description of VM
   sockets=1
   vcpu_per_socket=1
   thread_per_core=1
 ...
 #now resize VM disk to desired size
   ...
   resize_task_status=api.wait_for_task(resize_task_uuid)
